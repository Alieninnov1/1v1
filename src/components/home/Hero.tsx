...
const Hero = () => {
  return (
    <section className="bg-gradient-to-br from-white to-helix-purple50 dark:from-gray-900 dark:to-helix-purple900 py-16 sm:py-20 md:py-28">
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                className="absolute -left-16 -top-10 flex items-center justify-center h-24 w-24 rounded-full bg-white border-2 border-helix-purple shadow-md"
              >
              ...
              <motion.div
                ...
                className="absolute -right-16 -top-10 flex items-center justify-center h-24 w-24 rounded-full bg-white border-2 border-helix-purple shadow-md"
              >
                <div className="text-center">
              ...
              <motion.div
                ...
                className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 flex items-center justify-center h-24 w-24 rounded-full bg-white border-2 border-helix-purple shadow-md"
              >
                <div className="text-center">
