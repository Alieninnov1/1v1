...
const TaskbarButton = ({
  ...
  return <Button variant="ghost" className={`xp-window-button-taskbar h-8 rounded-none flex items-center px-2 gap-1.5 text-xs ${active ? "bg-[#2A6CB7] shadow-inner" : ""}`} onClick={onClick}>
...
const Taskbar = () => {
  ...
  return <>
      {/* Start Menu */}
      <AnimatePresence>
        {showStartMenu && <motion.div className="xp-start-menu" initial="hidden" animate="visible" exit="hidden" variants={startMenuVariants}>
            ...
            <div className="bg-white p-1">
              <div className="flex flex-col sm:flex-row">
                ...
                setShowStartMenu(false);
              }} className="xp-start-item flex items-center p-1.5 cursor-pointer rounded-sm transition-colors bg-indigo-900">
                    <div className="bg-blue-500 w-7 h-7 rounded flex items-center justify-center text-white mr-2">
                      <span className="text-xs">e</span>
                    </div>
                    <span className="text-sm">Internet</span>
                  </div>
                  <div className="xp-start-item flex items-center p-1.5 hover:bg-blue-100 cursor-pointer rounded-sm transition-colors" onClick={() => {
                toast({
                  title: "Email",
                ...
                <div className="w-full sm:w-32 p-2 space-y-1 bg-indigo-900">
                  ...
                  <div className="xp-start-item flex items-center p-1.5 hover:bg-blue-200 cursor-pointer text-sm rounded-sm transition-colors" onClick={() => {
                ...
                setShowStartMenu(false);
              }} className="xp-start-item flex items-center p-1.5 cursor-pointer text-sm rounded-sm transition-colors bg-indigo-950">
              ...
              <div className="flex justify-between p-1 bg-indigo-950">
                <button className="xp-start-item flex items-center p-1.5 hover:bg-blue-100 cursor-pointer rounded-sm transition-colors" onClick={() => {
              toast({
                title: "Log Off",
      ...
      <div className="xp-taskbar bg-indigo-900">
        ...
        <div className="flex overflow-x-auto mx-1 flex-grow">
          {openWindows.map(window => <TaskbarButton key={window.id} label={window.label} icon={window.icon} />)}
        </div>
        <div className="xp-clock flex items-center gap-2 px-2">
          {!isMobile && <>
              <Volume2 size={14} className="cursor-pointer" onClick={() => toast({
            title: "Volume",
            description: "Volume controls would appear here"
          })} />
              <Wifi size={14} className="cursor-pointer" onClick={() => toast({
            title: "Network",
